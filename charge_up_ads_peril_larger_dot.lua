-- File: Targeter/scripts/mods/Targeter/crosshairs/charge_up_ads_peril_larger_dot.lua
...
local center_size = { 8, 8 }
local spread_distance = 10
local hit_default_distance = 10
local hit_size = { 14, 4 }

template.name = "charge_up_ads_peril_larger_dot"
template.size = size
...
function template.on_enter(widget, template, data) end
